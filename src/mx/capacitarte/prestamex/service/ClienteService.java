...
public class ClienteService {
	...
	public List<ClienteBean> cargarClientes() {
		...
		ClienteBean clienteBean1 = new ClienteBean(001, "Alicia", "Alva", "Aguilar", "10/12/1980", "F", "ALAA801210B12",
				"5552347689", "alicia_alva@gmail.com", "salina cruz", true);
		ClienteBean clienteBean2 = new ClienteBean(002, "Adrian", "Martinez", "Lopez", "10/07/1985", "M",
				"MALA850710H34", "7771230956", "adrian_mar@gmail.com", "tehuantepec", true);
	...
	public Boolean agregarClientes(ClienteBean clienteBean) {
		ClientesFiles clientesFiles = new ClientesFiles();
		Boolean resultadoAgregarCliente = clientesFiles.agregarCliente(clienteBean);

		System.out.println("El resultado de agregar cliente fue: " + resultadoAgregarCliente);

		return resultadoAgregarCliente;
